var ListProduct = [{
  ...
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/b/u/burger_b_khoai_t_y_l_t_1.jpg",
  category: 1
},
{
  id: 2, 
  ...
  price: 35,
  desc: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos ipsa debitis inventore numquam, ex sint. Perferendis impedit vel recusandae accusantium illo deleniti ratione sint magni, debitis quo quos inventore?",
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/8/-/8-burger-b_-ph_-mai.jpg",
  category: 1
},
{
  id: 3, 
  ...
  price: 40,
  desc: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos ipsa debitis inventore numquam, ex sint. Perferendis impedit vel recusandae accusantium illo deleniti ratione sint magni, debitis quo quos inventore?",
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/1/5/15-burger-g_-n_ng_1.jpg",
  category: 1
},
{
  id: 4,
  ...
  price: 36,
  desc: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos ipsa debitis inventore numquam, ex sint. Perferendis impedit vel recusandae accusantium illo deleniti ratione sint magni, debitis quo quos inventore?",
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/1/-/1-mieng-ga-gion-ko-cay.jpg",
  category: 3
},
{
  id: 5,
  ...
  price: 25,
  desc: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos ipsa debitis inventore numquam, ex sint. Perferendis impedit vel recusandae accusantium illo deleniti ratione sint magni, debitis quo quos inventore?",
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/c/a/ca_cuo_n_rong_bie_n_2pcs_.jpg_1.jpg",
  category: 4
},
{
  id: 6,
  ...
  price: 40,
  desc: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos ipsa debitis inventore numquam, ex sint. Perferendis impedit vel recusandae accusantium illo deleniti ratione sint magni, debitis quo quos inventore?",
  image: "https://burgerking.vn/media/catalog/product/cache/1/small_image/316x/9df78eab33525d08d6e5fb8d27136e95/1/-/1-canh-ga-bbq.jpg",
  category: 6
}
,
{
...
var ListCategory = [{
  id: 1,
  name: "Món mới",
  image: "https://png.pngtree.com/png-vector/20190501/ourmid/pngtree-new-icon-design-png-image_1012797.jpg"
},
{
  id: 2,
  name: "Combo",
  image: "https://aeonmall-binhduongcanary.com.vn/wp-content/uploads/2020/08/18d46e3c3c7c3f-2810004_01miengcj01khoaivua01pepsi.png"
},
{
  id: 3,
  name: "Burger",
  image: "https://product.hstatic.net/200000291375/product/item_03_c50afed6762c4db7a4020f3fd2b0c679_master.jpg"
},
{
  id: 4,
  name: "Gà rán",
  image: "https://ruavangfood.com/storage/uploads/2021/11/13/618f10c7363e4.png"
},
{
  id: 6,
  name: "Sandwich",
  image: "https://lh3.googleusercontent.com/-zwMcTQoXPTQ/WLUGpTyWXYI/AAAAAAABCOI/TjtQkE8cYHc/s1000/cach-lam-banh-mi-sandwich-ngon-don-gian.html-image00.png"
},
{
  id: 5,
  name: "Thức Uống",
  image: "https://phuclong.com.vn/uploads/dish/d38f5a0deb702b-lytravai_thuytinh11.png"
}
];
var ListBlogPosts = [{
  id: 1,
...
{
  id: 2,
  title: "5 Must-Make Toddler-Friendly Dinners from Michelle Piccolo of Feeding Our Toddlers",
...
{
  id: 3,
  title: "Fly By Jing Just Launched a Zingy Limited-Edition Seasoning That Hot Pepper Fans Will Love",
...
var cart = [];
function renderProducts(selector, data = ListProduct, isShowPrice = false, limit = 0) {
  const products = document.querySelector(selector);
  if (Array.isArray(data)) {
      let categoryId = Number(new URLSearchParams(window.location.search).get('category-id'));
      if (categoryId) {
      ...
      if (data.length > 9) {
          data = paginate(data, 9);
      }
      let htmls = data.reduce((acc, product) => {
                  return acc +=
                      `
              <div class="product-item">
                  <a href="../view/detail.html?product-id=${product.id}">
